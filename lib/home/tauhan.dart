...
class Tauhan extends StatefulWidget {
  final String firstName;
  final String email;

  const Tauhan({super.key, required this.firstName, required this.email});

  @override
  State<Tauhan> createState() => _TauhanState();
}

class _TauhanState extends State<Tauhan> {
