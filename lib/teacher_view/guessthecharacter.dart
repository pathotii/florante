...
class TeacherGuessTheCharacterQuiz extends StatefulWidget {

  const TeacherGuessTheCharacterQuiz({super.key});

  @override
  _TeacherGuessTheCharacterQuizState createState() => _TeacherGuessTheCharacterQuizState();
}

class _TeacherGuessTheCharacterQuizState extends State<TeacherGuessTheCharacterQuiz> {
  ...
  Widget build(BuildContext context) {
    ...
    if (characters.isEmpty) {
      return const Center(child: Text("Walang Karakter"));
    }
