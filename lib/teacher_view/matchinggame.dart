...
class TeacherMatchingGame extends StatefulWidget {
  const TeacherMatchingGame({super.key});

  @override
  _TeacherMatchingGameState createState() => _TeacherMatchingGameState();
}

class _TeacherMatchingGameState extends State<TeacherMatchingGame> {
